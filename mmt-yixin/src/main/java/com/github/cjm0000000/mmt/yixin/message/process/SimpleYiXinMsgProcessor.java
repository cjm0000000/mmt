...
public class SimpleYiXinMsgProcessor extends AbstractPassiveMsgProcessor {
	...
	@Override
	protected BaseMessage processAudioMsg(MmtConfig cfg, AudioMessage msg) {
		return sendTextMessage(msg, "亲，我暂时无法识别语音信息哦，您可以给我发文字消息。");
	}

	@Override
	protected BaseMessage processImageMsg(MmtConfig cfg, ImageMessage msg) {
		return sendTextMessage(msg, "亲，我暂时无法识别图片信息哦，您可以给我发文字消息。");
	}

	@Override
	protected BaseMessage processLinkMsg(MmtConfig cfg, LinkMessage msg) {
		return sendTextMessage(msg, "亲，我暂时无法识别链接信息哦，您可以给我发文字消息。");
	}

	@Override
	protected BaseMessage processLocationMsg(MmtConfig cfg, LocationMessage msg) {
		return sendTextMessage(msg, "亲，我暂时无法识别地理位置信息哦，您可以给我发文字消息。");
	}

	@Override
	protected BaseMessage processVideoMsg(MmtConfig cfg, IVideo msg) {
		return sendTextMessage((BaseMessage) msg, "亲，我暂时无法识别链接信息哦，您可以给我发文字消息。");
	}

	@Override
	protected BaseMessage processVoiceMsg(MmtConfig cfg, VoiceMessage msg) {
