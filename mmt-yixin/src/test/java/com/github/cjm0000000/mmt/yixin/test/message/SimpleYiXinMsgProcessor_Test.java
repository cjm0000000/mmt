...
public class SimpleYiXinMsgProcessor_Test extends AbstractYiXinTester {
	...
	public void textMsgTest(){
		...
		com.github.cjm0000000.mmt.core.message.send.passive.TextMessage result = (com.github.cjm0000000.mmt.core.message.send.passive.TextMessage) api.process(MMT_TOKEN, MmtXMLParser.fromXML(txtMsg));
	...
	public void subscribeTest(){
		...
		com.github.cjm0000000.mmt.core.message.send.passive.TextMessage result = (com.github.cjm0000000.mmt.core.message.send.passive.TextMessage) api.process(MMT_TOKEN, MmtXMLParser.fromXML(recvMsg));
	...
	public void videoMsgTest(){
		...
		com.github.cjm0000000.mmt.core.message.send.passive.TextMessage result = (com.github.cjm0000000.mmt.core.message.send.passive.TextMessage) api.process(MMT_TOKEN, MmtXMLParser.fromXML(recvMsg));
		assertEquals(result.getContent(),"亲，我暂时无法识别视频信息哦，您可以给我发文字消息。");
	}
	...
	public void musicMsgTest(){
		...
		com.github.cjm0000000.mmt.core.message.send.passive.TextMessage result = (com.github.cjm0000000.mmt.core.message.send.passive.TextMessage) api.process(MMT_TOKEN, MmtXMLParser.fromXML(recvMsg));
		assertEquals(result.getContent(),"亲，我暂时无法识别音乐哦，您可以给我发文字消息。");
	}
