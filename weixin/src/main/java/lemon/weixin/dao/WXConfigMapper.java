...
public interface WXConfigMapper {
	 ...
	 * @param config
	 */
	@Update("UPDATE weixin_config A SET A.wx_account=#{wx_account},A.token=#{token},A.subscribe_msg=#{subscribe_msg},A.welcome_msg=#{welcome_msg},A.account_type=#{account_type} WHERE A.cust_id=#{cust_id}")
