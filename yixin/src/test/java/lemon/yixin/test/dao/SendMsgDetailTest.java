...
import lemon.yixin.message.mapper.YXSendMsgDetailMapper;
import lemon.yixin.message.parser.MusicMsgParser;
import lemon.yixin.message.parser.NewsMsgParser;
